...
public class LanguageServersRegistry {
    ...
    private void loadServersAndMappingFromSettings() {
        for (var launch : LaunchConfigurationLanguageServerSettings.getInstance().getLaunchConfigDefinitionSettings()) {
            ...
            addServerDefinitionWithoutNotification(new LaunchingLanguageServerDefinition(serverId, launch.getServerName(), "", launch.getCommandLine()), mappings);
        }
    }
    ...
    private void addServerDefinitionWithoutNotification(@NotNull LanguageServerDefinition definition, @NotNull List<ServerMapping> mappings) {
        ...
        // Update settings
        if (definition instanceof LaunchingLanguageServerDefinition definitionFromSettings) {
    ...
    public void removeServerDefinition(LanguageServerDefinition definition) {
        ...
        updateInlayHintsProviders();
        // Update settings
        LaunchConfigurationLanguageServerSettings.getInstance().removeServerDefinition(definition.id);
        // Notifications
        for (LanguageServerDefinitionListener listener : this.listeners) {
            try {
    ...
    public void updateServerDefinition(@NotNull LaunchingLanguageServerDefinition definition,
        ...
        LaunchConfigurationLanguageServerSettings.LaunchConfigDefinitionSettings settings = LaunchConfigurationLanguageServerSettings.getInstance().getLaunchConfigSettings(definition.id);
