...
public class DisassemblyFile extends DAPFile {
    ...
    public static final String FILE_NAME = "disassembly.lsp4ij";
    ...
    private final @NotNull String presentableName;
    ...
    public DisassemblyFile(@NotNull String configName,
        ...
        super("Disassembly (" + configName + ").disasm", path, project);
        this.presentableName = "Disassembly (" + configName + ")";
    }
