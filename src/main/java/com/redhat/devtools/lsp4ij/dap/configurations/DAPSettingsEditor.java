...
public class DAPSettingsEditor extends SettingsEditor<DAPRunConfiguration> {
    ...
    private void loadFromDapFactory(@NotNull UserDefinedDebugAdapterDescriptorFactory dapFactory) {
        ...
        connectingServerConfigurationPanel.update(getInt(dapFactory.getWaitForTimeout()), dapFactory.getWaitForTrace());
    ...
    protected void resetEditorFrom(DAPRunConfiguration runConfiguration) {
        ...
        connectingServerConfigurationPanel.update(runConfiguration.getWaitForTimeout(), runConfiguration.getWaitForTrace());
        ...
        if (currentServerFactory != null) {
            ...
            if (currentServerFactory instanceof UserDefinedDebugAdapterDescriptorFactory dapFactory) {
                ...
                if (dapFactory != UserDefinedDebugAdapterDescriptorFactory.NONE) {
                    ...
                    dapFactory.setFileTypeMappings(mappingsPanel.getFileTypeMappings());
                }
            }
        }
    }
    ...
    protected void disposeEditor() {
        /*if (currentServerFactory == null) {
            // Add new server factory
            DebugAdapterDescriptorFactory factory = new UserDefinedDebugAdapterDescriptorFactory(String.valueOf(UUID.randomUUID()),
                    serverNameField.getText(),
                    commandField.getText(),
                    mappingsPanel.getAllMappings());
            DebugAdapterDescriptorFactoryRegistry.getInstance().addDebugAdapterDescriptorFactory(factory);
        } else if (currentServerFactory instanceof UserDefinedDebugAdapterDescriptorFactory dapServerFactory) {
            // Update existing server factory
            dapServerFactory.setName(serverNameField.getText());
            dapServerFactory.setCommandLine(commandField.getText());
            dapServerFactory.setMappings(mappingsPanel.getAllMappings());
        }*/
        super.disposeEditor();
    }
}