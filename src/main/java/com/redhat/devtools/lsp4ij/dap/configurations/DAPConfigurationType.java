 ...
 */
final class DAPConfigurationType extends ConfigurationTypeBase {

    public static final String ID = "DAPConfiguration";

    public static DAPConfigurationType getInstance() {
        return ConfigurationTypeUtil.findConfigurationType(DAPConfigurationType.class);
    }

    DAPConfigurationType() {
        super(ID,
