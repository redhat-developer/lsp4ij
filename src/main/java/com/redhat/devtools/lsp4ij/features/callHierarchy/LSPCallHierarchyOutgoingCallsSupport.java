...
/**
 * LSP call hierarchy support outgoingCalls which loads and caches call hierarchy outgoingCalls by consuming:
 *
 * <ul>
 *     <li>LSP 'callHierarchy/outgoingCalls' requests</li>
 * </ul>
 */
public class LSPCallHierarchyOutgoingCallsSupport extends AbstractLSPDocumentFeatureSupport<CallHierarchyOutgoingCallsParams, List<CallHierarchyItemData>> {

    public LSPCallHierarchyOutgoingCallsSupport(@NotNull PsiFile file) {
        super(file);
    }

    public CompletableFuture<List<CallHierarchyItemData>> getCallHierarchyOutgoingCalls(CallHierarchyOutgoingCallsParams params) {
    ...
    private static CompletableFuture<List<CallHierarchyItemData>> getCallHierarchyOutgoingCalls(@NotNull CallHierarchyOutgoingCallsParams params,
        ...
        return cancellationSupport.execute(languageServer
                        ...
                        .callHierarchyOutgoingCalls(params), languageServer, LSPRequestConstants.CALL_HIERARCHY_OUTGOING_CALLS)
                .thenApplyAsync(callHierarchyOutgoingCalls -> {
                    if (callHierarchyOutgoingCalls == null) {
                        // callHierarchy/outgoingCalls may return null
                    ...
                    callHierarchyOutgoingCalls
                            .stream()
                            .map(c -> c.getTo())
                            .filter(LSPCallHierarchyOutgoingCallsSupport::isValidCallHierarchyItem)
