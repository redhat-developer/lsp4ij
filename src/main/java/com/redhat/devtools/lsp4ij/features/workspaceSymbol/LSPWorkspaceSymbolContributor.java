...
/**
 * LSP workspace symbol contributor.
 */
public class LSPWorkspaceSymbolContributor implements ChooseByNameContributorEx {

    private final static Logger LOGGER = LoggerFactory.getLogger(LSPWorkspaceSymbolContributor.class);
    ...
    private static List<WorkspaceSymbolData> getWorkspaceSymbols(@NotNull String name, boolean cancel, Project project) {
