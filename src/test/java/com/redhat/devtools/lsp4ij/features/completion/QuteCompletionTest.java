...
public class QuteCompletionTest extends LSPCompletionFixtureTestCase {
    ...
    public void testCompletionWithFor() {
        ...
        // Apply completion with #for
        assertApplyCompletionItem(0, // language=html
                """
                <ul>
                    {#for item in items}
                        {item.name}<caret>
    ...
    public void testCompletionWithIf() {
        // 1. Test completion items response
        assertCompletion("test.html",
                // language=html
                """
                ...
                ,
                "if", "for");
        // 2. Test new editor content after applying the first second item
        // Apply completion with #if
        assertApplyCompletionItem(1, // language=html
                """
                <ul>
                    {#if condition}
                        <caret>
