...
/**
 * As <a href="https://github.com/JetBrains/intellij-community/blob/master/platform/platform-tests/testSrc/com/intellij/codeInsight/inline/completion/InlineCompletionTestCase.kt">InlineCompletionTestCase.kt</a>
 * is internal, we copy/paste this InlineCompletionTestCase in this LSP4IJ package.
 */
abstract class InlineCompletionTestCase : BasePlatformTestCase() {
    // !!! VERY IMPORTANT !!!
