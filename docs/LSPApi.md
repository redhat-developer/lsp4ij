...
| boolean useTemplateForInvocationOnlyCodeSnippet(PsiFile file)                         | Returns `true` if an editor template should be used for invocation-only code snippets and `false` otherwise.                                                                                                                       | `true`                                                                                |
