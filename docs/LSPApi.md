...
| boolean serverReportsOffsetOnlyPositions(PsiFile file)       | Returns `true` if the language server reports `Position` values as pure offsets and `false` otherwise.                                                                                                                                                                                                                                                                                         | `false`           | 
